            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                 ...
                 <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/add-manufacture')}}">Thêm thương hiệu </a></li>
                        <li><a href="{{URL::to('/all-manufacture')}}">Liệt kê thương hiệu</a></li>
                ...
                <!-- Social Link -->
                  <li class="sub-menu">
                        <a href="{{URL::to('/manage-order')}}"><span>quản lý đơn hàng</span></a>
